...
# This script is deprecated in favor of New-AzSqlInstanceLink cmdlet from Az.Sql module
# https://docs.microsoft.com/en-us/powershell/module/az.sql/new-azsqlinstancelink?view=azps-8.0.0
