...
# This script is deprecated in favor of Update-AzSqlInstanceLink cmdlet from Az.Sql module
# https://docs.microsoft.com/en-us/powershell/module/az.sql/update-azsqlinstancelink?view=azps-8.0.0
